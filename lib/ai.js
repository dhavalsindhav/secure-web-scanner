...
const { OpenAI } = safeRequire('openai', { OpenAI: createUnavailableFeatureProxy('OpenAI') });
const { Tokenizer } = safeRequire('gpt-4-tokenizer', { Tokenizer: createUnavailableFeatureProxy('Tokenizer') });
